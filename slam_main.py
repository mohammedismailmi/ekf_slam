...
#                 color_val = int(prob * 255) # CHANGED
...
#         pygame.draw.rect(screen, DARK_GRAY, map_rect) # CHANGED
#         pygame.draw.rect(screen, WHITE, map_rect, 2) # CHANGED
...
#                 pygame.draw.rect(screen, WHITE, clipped_rect) # CHANGED
...
#         # Initialize camera
#         self.camera = Camera(fov=60, max_range=200) # Reduced FOV and range
...
#     def draw(self):
#         """Draw everything"""
#         self.screen.fill(DARK_GRAY) # CHANGED
...
#             pygame.draw.rect(self.screen, WHITE, wall) # CHANGED
...
#                     text = font.render(str(lm_id), True, WHITE) # CHANGED
...
#             surface = font.render(text, True, BLACK) # CHANGED
